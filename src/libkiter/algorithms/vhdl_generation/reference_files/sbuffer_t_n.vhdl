-- Scheduled buffer
-- Time-driven buffer: stores data from in_data to memory at given trigger_push
-- signal; writes data from memory at given trigger_pop signal.
...
-- operation.
-- Requires input signals to trigger push and pop processes (we use scheduler.vhd).
library ieee;
