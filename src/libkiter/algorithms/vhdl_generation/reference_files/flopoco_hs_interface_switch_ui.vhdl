...
architecture connections of $ENTITY_NAME is
  ...
  -- internal signals
  signal hsm_out_data0, cd_in_ready, cd_in_valid, cd_trigger_store,
    ss_can_store : std_logic;
  signal flopoco_out_result : std_logic_vector (bit_width-1 downto 0);

begin

  hsm: hs_merger_switch_ui
