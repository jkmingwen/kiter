...
ADD_TRANSFORMATION(remove,
		transformation_action_t({"remove" , "Remove tasks with the name or the id specified", algorithms::transformation::remove_task}));
ADD_TRANSFORMATION(bugfix,
		transformation_action_t({"bugfix" , "A bugfix tool that try to reduce the size of a graph while keeping anomaly between kiter and SDF3", algorithms::transformation::compare_sdf3_throughput}));
