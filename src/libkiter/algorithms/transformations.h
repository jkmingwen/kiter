...
ADD_TRANSFORMATION(remove,"Remove tasks with the name or the id specified", algorithms::transformation::remove_task);
ADD_TRANSFORMATION(bugfix, "A bugfix tool that try to reduce the size of a graph while keeping anomaly between kiter and SDF3", algorithms::transformation::compare_sdf3_throughput);
