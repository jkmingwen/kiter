...
ADD_TRANSFORMATION(AddIOLoop, "Take any output tasks and connect it to any input task. Weights only works for HSDFG.", algorithms::transformation::add_input_output_loop);
