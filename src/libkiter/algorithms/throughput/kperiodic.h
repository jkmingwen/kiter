...
bool sameset(const models::Dataflow* const dataflow, critical_circuit_t *cc1 , critical_circuit_t* cc2) ;
std::string cc2string  (const models::Dataflow* const dataflow,critical_circuit_t* cc) ;
...
std::string print_schedule (models::EventGraph* eg, models::Dataflow* const  dataflow,  const periodicity_vector_t & kvector , TIME_UNIT res ) ;
  ...
  models::EventGraph*  updateEventGraph(const  models::Dataflow * const dataflow ,  periodicity_vector_t * kvector, critical_circuit_t* cc, models::EventGraph* g) ;
 models::EventGraph*  generateCycleOnly(models::Dataflow * const dataflow , const periodicity_vector_t * kValues,   critical_circuit_t * cc );

TIME_UNIT                compute_Kperiodic_throughput              (models::Dataflow *  const , parameters_list_t);

    TIME_UNIT                compute_1Kperiodic_throughput   		  (models::Dataflow* const  dataflow, parameters_list_t);
    TIME_UNIT                compute_2Kperiodic_throughput             (models::Dataflow* const  dataflow, parameters_list_t);
    TIME_UNIT                compute_NKperiodic_throughput             (models::Dataflow* const  dataflow, parameters_list_t);
    ...
    bool                                     updateVectorWithLocalNi  (const models::Dataflow *  const  , periodicity_vector_t *  , critical_circuit_t * ) ;
